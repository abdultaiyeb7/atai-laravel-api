...
// Add this for the Question model
=======
...
<<<<<<< HEAD
    ...
    //             ->select('id', 'client_name', 'contact', 'email', 'last_question', 'created_at', 'updated_at')
    //             ->first();
    //         dd($inquiry);
    //         if (! $inquiry) {
    //             return response()->json([
    ...
    public function getUserInquiry(Request $request)
    {
        try {
            ...
            // Check the inquiry object to see if created_at and updated_at are present
            dd($inquiry);
            ...
            $response = [
                ...
                'created_at'    => $inquiry->created_at ? $inquiry->created_at->toDateTimeString() : null,
                'updated_at'    => $inquiry->updated_at ? $inquiry->updated_at->toDateTimeString() : null,
            ];
